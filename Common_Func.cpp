...
bool Coin_Item::_BaseObject_LoadImg(std::string path, SDL_Renderer* screen)
{
    SDL_Texture* new_texture = NULL;
...
bool Coin_Item::LoadImg(std::string path, SDL_Renderer* screen)
{
    bool ret = Coin_Item::_BaseObject_LoadImg(path, screen);
...
{
    if(type_of_coin<=2)LoadImg("CatPNG//G_coin.png", des);
    else if (type_of_coin <= 15 && type_of_coin >2) LoadImg("CatPNG//Sil_coin.png", des);
    else if (type_of_coin >15 && type_of_coin<=40) LoadImg("CatPNG//Br_coin.png", des);
    else if (type_of_coin > 40) LoadImg("CatPNG//G_star.png", des);
...
bool ItemsObject::_BaseObject_LoadImg(std::string path, SDL_Renderer* screen)
{
    SDL_Texture* new_texture = NULL;
...
{
    bool ret = ItemsObject::_BaseObject_LoadImg(path, screen);
...
{ 
        LoadImg("CatPNG//menu_cat.png", des);
        frame_++;
    if (frame_ >= 8)
    {
        frame_ = 0;
